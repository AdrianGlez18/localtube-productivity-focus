...
const LikedVideoCard = ({ video, handleVideoClick, handleDelete, isLoading }: LikedVideoCardProps) => {
  return (
    <div
      key={video.id}
    ...
    >
      <div className="relative">
        ...
        <div className="absolute top-2 right-2 flex gap-2">
          <button className="bg-white p-1 rounded-md border-2 border-black hover:bg-red-300 transition-colors cursor-pointer" onClick={() => handleDelete(video.id)} disabled={isLoading}>
            <svg
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mt-2">
          ...
          <button className="bg-white p-1 rounded-md border-2 border-black hover:bg-blue-100 transition-colors cursor-pointer" disabled={isLoading}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
